...
if ($validator->isValid()) {
    ...
    try {
        ...
        $post->update( $post_id);
        echo "تم إنشاء المقالة بنجاح! معرف المقالة هو: " . $post->id;
        header("Location:list_posts.php");
            exit();
    } catch (Exception $e) {
        echo "حدث خطأ أثناء إنشاء المقالة: " . $e->getMessage();
    }
    // Proceed with form processing (e.g., save to the database)
} else {
    // Output errors
...
<body>
    ...
    <div class="container-lg mt-5">
        ...
        <form method="POST">
            ...
            <?php endif; ?>
            <!-- Title Input -->
            <input class="form-control form-control-lg mb-3" type="text" id="title" name="title" value="<?php echo $post_val['title']; ?>"
            placeholder="Title" aria-label="default input example">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="content" name="content" rows="3"><?php echo $post_val['content']; ?>
                </textarea>
            </div>
            ...
            <!-- Author Input -->
            <input class="form-control form-control-lg mb-3" type="text" id="author" name="author"  value="<?php echo $post_val['author']; ?>" placeholder="Author" aria-label="default input example">
